...
Mojolicious C<.ep> templates mix HTML and Perl-like template directives. The
formatter keeps separate visual tracks for Embedded Perl control flow and HTML
structure.

Percent-code lines align according to EP/code flow. HTML payload lines align
according to local HTML structure. In mixed regions those columns may differ
intentionally.
...
Enable additional cleanup passes.
