...
=head2 --cleanup / --no-cleanup

Remove PrettyTidy temporary files during normal operation. Enabled by default.

Use C<--no-cleanup> to preserve perltidy scratch files and diagnostics after a
run.
